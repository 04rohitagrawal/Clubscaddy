...
public class InstagramApp {
	...
	public InstagramApp(Activity context, String clientId, String clientSecret,
						String callbackUrl) {
		...
		mDialog.getWindow().setLayout(AppConstants.getDeviceWidth(mCtx) , AppConstants.getDeviceHeight(mCtx) );
		...
		new Thread() {
			...
			public void run() {
				...
				try {
					...
					writer.flush();
					String response = Utill.streamToString(urlConnection
							.getInputStream());
	...
	public void authorize() {
		...
		mDialog.getWindow().setBackgroundDrawableResource(R.color.white_color);
		mDialog.show();
	}
