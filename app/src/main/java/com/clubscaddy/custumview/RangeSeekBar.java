...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        float barHeight;
        int thumbNormal = R.drawable.whit_circle_for_dialog;
        int thumbPressed = R.drawable.whit_circle_for_dialog;
        int thumbDisabled = R.drawable.whit_circle_for_dialog;
        ...
        if (attrs == null) {
            ...
            try {
                ...
                corner_radious = a.getInt(R.styleable.RangeSeekBar_corner_radious , 0);
    ...
    protected synchronized void onDraw(@NonNull Canvas canvas) {
        ...
        canvas.drawRoundRect(rect,corner_radious,corner_radious, paint);
